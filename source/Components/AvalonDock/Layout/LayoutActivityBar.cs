...
namespace AvalonDock.Layout {
	...
	[Serializable]
	public class LayoutActivityBar :LayoutPositionableGroup<LayoutAnchorableExpanderGroup>, ILayoutAnchorablePane, ILayoutPositionableElement, ILayoutPaneSerializable {
		#region fields
		...
		public LayoutActivityBar(LayoutAnchorableExpanderGroup anchorable) {
