...
namespace AvalonDock.Layout {
	...
	[Serializable]
	public class LayoutAnchorableExpander2 : LayoutPositionableGroup<LayoutAnchorable>, ILayoutAnchorablePane, ILayoutPositionableElement, ILayoutPaneSerializable
	{
		#region fields
