...
namespace AvalonDock.Controls {
	public class LayoutToggleButtonControl :ToggleButton {
		...
		public static readonly DependencyProperty ModelProperty = DependencyProperty.Register(nameof(Model), typeof(LayoutAnchorableExpanderGroupBox), typeof(LayoutToggleButtonControl),
		...
		public LayoutAnchorableExpanderGroupBox Model {
			get => (LayoutAnchorableExpanderGroupBox) GetValue(ModelProperty);
