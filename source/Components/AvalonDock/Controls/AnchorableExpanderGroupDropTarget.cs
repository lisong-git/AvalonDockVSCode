...
//		internal AnchorableExpanderGroupDropTarget(LayoutAnchorableExpanderGroupControl manager,
//										  Rect detectionRect,
//										  DropTargetType type)
...
//		{
//			Debug.WriteLine($"{Type}", "AnchorableExpanderGroupDropTarget Drop 1");
...
//							Debug.WriteLine($"{layoutAnchorablePaneGroup?.Children.Count}", "AnchorableExpanderGroupDropTarget Drop 2");
...
//									Debug.WriteLine($"{anchorablesToMove[i].Children.FirstOrDefault()}", "AnchorableExpanderGroupDropTarget Drop 3");
...
//								}
//							} else {
//								Debug.WriteLine($"", "AnchorableExpanderGroupDropTarget Drop 4");
