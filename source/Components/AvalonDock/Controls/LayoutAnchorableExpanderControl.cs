...
namespace AvalonDock.Controls {
	...
	/// See also <seealso cref="LayoutAnchorableExpanderControl"/>.
	/// </summary>
	...
	public class LayoutAnchorableExpanderControl :Expander, ILayoutControl//, ILogicalChildrenContainer
	{
		...
		static LayoutAnchorableExpanderControl() {
			DefaultStyleKeyProperty.OverrideMetadata(typeof(LayoutAnchorableExpanderControl), new FrameworkPropertyMetadata(typeof(LayoutAnchorableExpanderControl)));
	  ...
	  ILayoutElement ILayoutControl.Model => Model;
		...
		public static readonly DependencyProperty ModelProperty = DependencyProperty.Register(nameof(Model), typeof(LayoutAnchorableExpander), typeof(LayoutAnchorableExpanderControl),
		...
		private static void OnModelChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) => ((LayoutAnchorableExpanderControl) d).OnModelChanged(e);
		...
		private void Model_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e) {
			if(e.PropertyName != nameof(LayoutAnchorableExpander.IsEnabled))
				return;
			if(Model == null)
				return;
			...
			if(IsEnabled || !Model.IsActive)
				return;
			if(Model.Parent != null && Model.Parent is LayoutAnchorableExpanderGroup group)
		...
		private static readonly DependencyPropertyKey LayoutItemPropertyKey = DependencyProperty.RegisterReadOnly(nameof(LayoutItem), typeof(LayoutItem), typeof(LayoutAnchorableExpanderControl),
